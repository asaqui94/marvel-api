...
class Marvel(db.Model):
    ...
    def to_dict(self):
        return {
            "id": self.id,
            "name": self.name,
            "appeared_in": self.appeared_in,
            "superpower": self.superpower
        }

class MarvelSchema(ma.Schema):
    class Meta:
        fields = ['id', 'name', 'appeared_in', 'superpower']
